...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    title: "BioVostok",
    description:
      "Интернет-магазин натуральных добавок и средств для здоровья. Строгий отбор товаров с проверенными составами без агрессивной химии, индивидуальный подход к каждому клиенту и доставка по всему миру.",
    technologies: ["Python", "Django", "PostgreSQL", "Docker"],
    image: "/bioVostock/main-page.webp",
    screenshots: [
      "/bioVostock/main-page.webp",
      "/bioVostock/main-page2.webp",
      "/bioVostock/product-page.webp",
      "/bioVostock/product-page2.webp",
      "/bioVostock/cart.webp",
      "/bioVostock/cart-2.webp",
      "/bioVostock/admin-panel.webp",
      "/bioVostock/screenshot-2026-06-25.webp",
    ],
  },
  {
    id: "lulu-cold-brew",
    title: "LULU Cold Brew",
    description:
      "Одностраничный лендинг для оптовых B2B-продаж готового колд брю в HoReCa. Натуральный кофе без сахара, четыре вкуса на основе арабики и натуральных соков, бесплатное брендирование этикеток (white label), доставка по всей России.",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"],
    image: "/lulu/lulu-1.webp",
    screenshots: [
      "/lulu/lulu-1.webp",
      "/lulu/lulu-2.webp",
      "/lulu/lulu-3.webp",
